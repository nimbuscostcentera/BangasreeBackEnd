  ...
  (req, res, next) => {
    ...
    const uploadPromises = req.files.map((file) => {
      ...
      if (file.fieldname == "NomineePhoto") {
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeProfilePhoto/${req.body.NomineeIdProofNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeIdProof/${req.body.NomineeIdProofNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeSignature/${req.body.NomineeIdProofNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
