  ...
  (req, res, next) => {
    ...
    const uploadPromises = req.files.map((file) => {
      ...
      if (file.fieldname == "Photo") {
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Agent/ProfilePhoto/${req.body.Phonenumber}.jpg`,
          Body: file.buffer,
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Agent/IdProof/${req.body.Phonenumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Agent/Signature/${req.body.Phonenumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
  ...
  (req, res, next) => {
    ...
    const uploadPromises = req.files.map((file) => {
      ...
      if (file.fieldname == "AplicantPhoto") {
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/ProfilePhoto/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/IdProof/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/Signature/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeProfilePhoto/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeIdProof/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Customer/NomineeSignature/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
  ...
  (req, res, next) => {
    ...
    const uploadPromises = req.files.map((file) => {
      ...
      if (file.fieldname == "Photo") {
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Superuser/ProfilePhoto/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Superuser/IdProof/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
        ...
        const params = {
          Bucket: BUCKET_NAME,
          Key: `Staging/Superuser/Signature/${req.body.PhoneNumber}.jpg`,
          Body: file.buffer,
          ACL: "public-read", // Change the ACL according to your requirement
        };
        return s3.upload(params).promise();
