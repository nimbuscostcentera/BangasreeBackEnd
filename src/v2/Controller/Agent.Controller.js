...
class AgentController {
  ...
  async customercollection(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await CustomerCollectionService.CustomerCollection(
        req,
        res,
        next
      );
  ...
  async customercollectionedit(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await CustomerCollectionService.CustomerCollectionEdit(
        req,
        res,
        next
      );
  ...
  async customercollectionlist(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await CollectionShowService.CustomerCollectionShow(
        req,
        res,
        next
      );
  ...
  async colectionsubmisson(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await CollectionSubmissonService.CollectionSubmisson(
        req,
        res,
        next
      );
  ...
  async schemeaddcustomer(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await SchemeAddCustomerService.SchemeAddCustomer(
        req,
        res,
        next
      );
  ...
  async schemeeditcustomer(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await SchemeAddCustomerService.SchemeEditCustomer(
        req,
        res,
        next
      );
  ...
  async schemedeletecustomer(req, res, next) {
    try {
      // console.log("controller", req.body);
      const CustomerCollectionResponse = await SchemeAddCustomerService.SchemeDeleteCustomer(
        req,
        res,
        next
      );
