    ...
    //   console.log(req.body);
      ...
      else if(AgentCode!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid and cm.AgentCode=am.Agentcode and  cm.AgentCode=:AgentCode ",
            {
      ...
      else if(dt!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid and cm.AgentCode=am.Agentcode and  et.CollDate<=:Date ",
            {
      ...
      else if(AgentCode!="" && MaturityStatus!="" && BonusStatus!="" && dt!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid and cm.AgentCode=am.Agentcode and  cm.AgentCode=:AgentCode  cr.MaturityStatus=:MaturityStatus and cr.BonusStatus=:BonusStatusa and et.CollDate<=:Date ",
            {
              replacements: {
                Date: dt,
                AgentCode: AgentCode,
        ...
        const Custsw = await sq.sync().then(async () => {
          ...
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid and cm.AgentCode=am.Agentcode ",
            {
              type: QueryTypes.SELECT,
            }
          ).then(async (rst) => {
