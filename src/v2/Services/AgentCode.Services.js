...
class ShowAreaCodeService {
  async AgentCodeShow(req, res, next) {
    try
    {
      ...
      var sql =
        "select a.AgentCode,a.Commision as Commission ,a.UUid,a.Name,b.BranchCode from agentmasters as a INNER JOIN usermasters as u on a.UUid=u.UUid INNER JOIN branchmasters as b on u.BranchId=b.BranchId where a.Status=1";
      var qt = {};
