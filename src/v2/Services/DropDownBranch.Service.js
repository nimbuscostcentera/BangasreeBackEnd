...
class ShowBranchService {
  async DropDownBranch(req, res, next) {
    try {
      ...
      sql =
        sql +
        "select B.BranchId,B.BranchCode,A.AreaID,B.BranchName,B.Status as BranchStatus,A.Status as AreaStatus,A.AreaName,A.Pincode,A.District,A.State from Bangasree.branchmasters as B,Bangasree.areamasters as A where B.AreaID =A.AreaID";
