...
class CollectionViewService {
  ...
  async CustomerCollectionShow(req, res, next) {
    ...
    //   console.log(req.body);
      ...
      if (req.body.CustomerID !="" && req.body.CustomerID !=null && req.body.CustomerID !=undefined  )
      {
        CustomerID=req.body.CustomerID
      } 
      if (req.body.PaymentStatus !="" && req.body.PaymentStatus !=null && req.body.PaymentStatus !=undefined  )
      {
      ...
      else if(BonusStatus!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,,sr.MaturityStatus,sr.BonusStatus  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid and cm.AgentCode=am.Agentcode and  sr.BonusStatus=:BonusStatus ",
            {
      ...
      else if(AgentCode!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,cm.AgentCode,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus,et.PaymentType  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid  and  cm.AgentCode=:AgentCode ",
            {
      ...
      else if(dt!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,cm.AgentCode,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus,et.PaymentType  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid  and  et.CollDate<=:Date ",
            {
      ...
      else if(CustomerID!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus,et.PaymentType  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid  and  cm.CustomerID=:CustomerID ",
            {
      ...
      else if(PaymentStatus!="")
      {
        const Custsw = await sq.sync().then(async () => {
          console.log("service1 ok");
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,am.AgentCode ,am.Name,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus,et.PaymentType  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,agentmasters as am where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid  and  et.PaymentStatus=:PaymentStatus ",
            {
        ...
        const Custsw = await sq.sync().then(async () => {
          ...
          sq.query(
            "SELECT et.CollectionId,et.CollectionUUId,cm.CustomerName,sm.SchemeTitle,et.CollectedAmt as totcolection,et.CollDate,sr.SUUid,sm.DurationType,sr.StartDate,sm.EmiAmt,cm.AgentCode ,et.PaymentMode,et.PaymentStatus,et.ChqNO,et.ChqDate,et.MICR,et.TransactionId,et.ReceiptNo,sr.MaturityStatus,sr.BonusStatus,et.PaymentType,crh.Comment  from customermasters as cm,schememasters as sm ,schemeregisters as sr,emitrans as et,schemeregisterhistories as srh where sr.UUid=cm.UUid and sr.SUUid = sm.SUUid and et.SUUid=sr.SUUid and et.CustomerUUid=sr.UUid  and sr.id=srh.SchemeRegId ",
            {
              type: QueryTypes.SELECT,
            }
          ).then(async (rst) => {
