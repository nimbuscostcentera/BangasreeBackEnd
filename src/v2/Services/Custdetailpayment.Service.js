...
class Custdetailpayment {
  ...
  try
  {
    ...
    if (req.body.NotAgentPayment != '' && req.body.NotAgentPayment != undefined && req.body.NotAgentPayment !=null )
    {
    ...
    var sqlstring =
      ...
      " et.MICR, et.TransactionId, sr.MaturityStatus, sr.BonusStatus, sr.CustomerAccNo, et.NotAgentPayment from customermasters " +
      " as cm, schememasters as sm, schemeregisters as sr, emitrans as et,agentmasters as am where sr.UUid = cm.UUid and sr.SUUid = sm.SUUid and " +
      " et.SchemeRegId = sr.id and et.CustomerUUid = sr.UUid and cm.AgentCode=am.AgentCode";
    ...
    if (SchemeRegId != '') {
      sqlstring =sqlstring+ " and sr.SchemeRegId=:SchemeRegId ";
